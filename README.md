...
* [ ] User can tap a tweet to **open a detailed tweet view**
  * [ ] User can **favorite (and unfavorite)** a tweet
...
* [x] timeline style
  ...
  * [x] rounded corners on embedded image media
  * [x] horizontal divider between tweets
...
challenges:
* integrating timeline and compose activities
* parsing JSON response from API
* styling the menu bar with Twitter colors and icons
* rate-limit exceeded
